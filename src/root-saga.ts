...
import {
  ...
  watchAddAndPopulateChannel, watchGetAnomaliesForChannel, watchGoToProjects, watchCopyRawToEdited, watchGetSitesForProjectAnomaliesScreen,
...
export function* rootSaga() {
  return yield all([
    ...
    fork(watchGetSitesForProjectAnomaliesScreen),
  ]);
}